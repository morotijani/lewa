...
const BASE_URL = 'http://192.168.0.122:3000/api';
...
export const courierApi = {
    ...
    updateProfile: (data: { userId: string, vehicleType: string, licensePlate: string }) => api.patch(`/couriers/profile/${data.userId}`, data),
};
...
export const orderApi = {
    ...
    decline: (orderId: string, userId: string) => api.post(`/orders/${orderId}/decline`, { userId }),
};
